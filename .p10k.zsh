# Generated by Powerlevel10k configuration wizard on 2025-07-16 at 12:09 BST.
...
# 2 lines, disconnected, no frame, sparse, few icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # direnv                # direnv status — disabled (not installed)
    # asdf                  # asdf version manager — not installed
    # virtualenv            # python venv — not used
    # anaconda              # conda — not installed
    # pyenv                 # python environment — not installed
    # goenv                 # go environment — not installed
    # nodenv                # node from nodenv — using volta instead
    # nvm                   # nvm — using volta instead
    # nodeenv               # nodeenv — not used
    node_version            # node.js version (project-only — only shows in folders with package.json)
    ...
    # rbenv                 # ruby — not installed
    # rvm                   # ruby — not installed
    # fvm                   # flutter — not installed
    # luaenv                # lua — not installed
    # jenv                  # jenv — not installed
    # plenv                 # perl — not installed
    # perlbrew              # perl — not installed
    # phpenv                # php — not installed
    # scalaenv              # scala — not installed
    # haskell_stack         # haskell — not installed
    # kubecontext           # kubernetes — not installed
    # terraform             # terraform — not installed
    # terraform_version     # terraform version
    aws                     # aws profile (SHOW_ON_COMMAND — silent unless aws/cdk/terraform invoked)
    # aws_eb_env            # elastic beanstalk — not used
    # azure                 # azure — not installed
    # gcloud                # gcloud — not installed
    # google_app_cred       # gcloud creds — not installed
    # toolbox               # container toolbox — not installed
    context                 # user@hostname (only shows for ssh/root)
    # nordvpn               # nordvpn — linux only
    # ranger                # ranger — not installed
    yazi                    # yazi shell
    # nnn                   # nnn — not installed
    # lf                    # lf — not installed
    # xplr                  # xplr — not installed
    vim_shell               # vim shell indicator (:sh) — cheap, only shows from inside vim
    # midnight_commander    # mc — not installed
    # nix_shell             # nix — not installed
    # chezmoi_shell         # chezmoi — not installed
    # vpn_ip                # virtual private network indicator
    # load                  # CPU load
    # disk_usage            # disk usage
    # ram                   # free RAM
    # swap                  # used swap
    # todo                  # todo.txt — not used
    # timewarrior           # timewarrior — not installed
    # taskwarrior           # taskwarrior — not installed
